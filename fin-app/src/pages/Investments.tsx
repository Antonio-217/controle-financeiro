...
export function Investments() {
    ...
    async function handleDelete(id: string) {
        if (confirm("Tem certeza que deseja excluir esta caixinha? O saldo será perdido.")) {
            try {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24">
                        ...
                        {investments.map(box => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        setMoveType("deposit"); // Padrão ao abrir
                                        setSelectedBox(box);
                                    }}
                                >
            ...
            {/* MODAL DE MOVIMENTAÇÃO (DEPOSITAR / SACAR) */}
                    ...
                    <DialogHeader className="p-6 pb-2">
                        <DialogTitle className="text-center flex flex-col items-center gap-2">
                            ...
                            <span className="text-zinc-800">
                                {moveType === 'deposit' ? 'Guardar Dinheiro' : 'Resgatar Valor'}
                            </span>
                        </DialogTitle>
